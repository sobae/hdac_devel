...
/*============================================================================================
   ...
   2018/02/00   changed included file
                changed the name of structure
   2018/03/19   added custfile
============================================================================================*/

#ifndef _HDAC_STATE_H_
#define	_HDAC_STATE_H_

#include "cust/custhdac.h"

#include "utils/define.h"
#include "chainparams/hdac/params.h"
#include "protocol/hdac/hdacscript.h"
...
{    
    ...
    void  InitDefaults()
    {
        ...
        m_NetworkParams=new mc_HdacParams;
        m_Permissions=NULL;
        m_Assets=NULL;
	...
	const bool PrevParamsHash(unsigned char* hash);
